...
internal class Program
{
    ...
    {
        // 1) Write a C# program that repeatedly prints "Hello!" and asks the user, "You still want to continue? (yes/no) ".
        // Use a "do-while" loop to continue execution as long as the user enters "yes"

        string usersChoice = "yes";
        ...
        // 2) Modify the given C# program in 1) to ensure the user input is case-insensitive when checking if they want to continue.
        // Use a "do-while" loop that keeps running as long as the user enters "yes" in any letter case (e.g., "Yes", "YES", "yEs").
        ...
        // 3) Write a C# program that repeatedly prints "Hello!" and asks the user, "You still want to continue? (yes/no) ".
        // Use a "while" loop to continue execution as long as the user enters "yes" in any letter case (e.g., "YES", "Yes", "yEs").
        ...
        // 4 slide 06) Write a C# program using a do-while loop that initializes a counter at 0 and increments it by 1 in each iteration.
        // The loop should continue running until the counter reaches a specified stop value (5). Display the counter value in each iteration.
        ...
        // 5 slide 07) Write a C# program that uses a do-while loop to print "Hello" five times.
        // Initialize a counter at 0, increment it in each iteration, and stop when the counter reaches 5.
